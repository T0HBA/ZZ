(() => {
    ...
    var t = {
            462: (t, e, a) => {
                ...
                class o {
                    ...
                    clearVelocity = t => {
                        t.state.velocity.init_y2kzbl$(), t.state.angularVelocity.init_y2kzbl$()
                    };
                    setAirBreakPosition = t => {
                        if (this.#t.killZoneData.state) {
                            let e = s.P6.isNotKillZone(t);
                            e !== i.W.None && s.P6.outKillZone(t, e)
                        }
                        t.x && 0 !== t.x && (this.#a.x = t.x), t.y && 0 !== t.y && (this.#a.y = t.y), t.z && 0 !== t.z && (this.#a.z = t.z)
                    };
                    onAirBreakActivated = t => {
                        this.setAirBreakPosition(t.body.state.position)
                    };
                    onAirBreakDeactivated = t => {
                        this.clearVelocity(t.body), t.body.movable = !0
                    };
                    toggleState = t => {
                        (this.#e = !this.#e) ? this.onAirBreakActivated(t): this.onAirBreakDeactivated(t)
                    };
                    setRayLenght = (t, e) => {
                        t && (t.params_0.maxRayLength = e)
                    };
                    align = (t, e) => {
                        if (t.state.velocity.z = 0, t.state.angularVelocity.x = 0, t.state.angularVelocity.y = 0, t.state.orientation.x = 0, t.state.orientation.y = 0, "noob" === e) return t.state.angularVelocity.z = 0, t.state.velocity.x = 0, t.state.velocity.y = 0, t.state.orientation.w = 0, void(t.state.orientation.z = 0);
                        0 !== e && (t.state.angularVelocity.z = 0, t.state.velocity.x = 0, t.state.velocity.y = 0, t.state.orientation.w = Math.sin(-(e - Math.PI) / 2), t.state.orientation.z = Math.cos(-(e - Math.PI) / 2))
                    };
                    alignTank = (t, e) => {
                        switch (this.#t.typeData.state) {
                            ...
                            case "default":
                                ...
                                break;
                            case "noob":
                                this.align(t.body, "noob")
                        }
                    };
                    setSmoothPosition = (t, e, a) => {
                        "default" !== this.#t.typeData.state && "noob" !== this.#t.typeData.state || (t.x += (e.x - t.x) / a, t.y += (e.y - t.y) / a), t.z += (e.z - t.z) / a
                    };
                    setPosition = t => {
                        this.setSmoothPosition(t.body.state.position, this.#a, this.#t.smoothData.state)
                    };
                    getSpeed = t => {
                        switch (t) {
                            case "forward":
                    ...
                    onMoved = (t, e = 0) => {
                        let a = this.getSpeed(t),
                            i = this.getRadian(t, e),
                            s = {
                                x: 0,
                                y: 0,
                                z: 0
                            ...
                            case "right":
                                switch (this.#t.typeData.state) {
                                    case "default":
                                        ...
                                        break;
                                    case "noob":
                                        "left" !== t && "right" !== t || (s.x = this.#a.x + a), "forward" !== t && "back" !== t || (s.y = this.#a.y + a)
                                }
                                break;
                            default:
                                s.z = this.#a.z + a
                    ...
                    keyHandler = t => {
                        let e;
                        switch (e = this.#t.speedData, s.P6.isBindPressed(e.inc) && (e.state += 10, e.state > 1e3 && (e.state = 1e3)), s.P6.isBindPressed(e.dec) && (e.state -= 10, e.state < 10 && (e.state = 10)), e = this.#t.smoothData, s.P6.isBindPressed(e.inc) && (e.state += 1, e.state > 100 && (e.state = 100)), s.P6.isBindPressed(e.dec) && (e.state -= 1, e.state < 1 && (e.state = 1)), e = this.#t.killZoneData, s.P6.isBindPressed(e) && (e.state = !e.state), e = this.#t.typeData, s.P6.isBindPressed(e.default) && (e.state = "default"), s.P6.isBindPressed(e.simple) && (e.state = "noob"), s.P6.isBindPressed(e.airWalk) && (e.state = "airWalk"), e = this.#t.movementData, this.#t.typeData.state) {
                            case "noob":
                                s.P6.isBindPressed(e.up) && this.onMoved("up"), s.P6.isBindPressed(e.down) && this.onMoved("down"), s.P6.isBindPressed(e.forward) && this.onMoved("forward"), s.P6.isBindPressed(e.back) && this.onMoved("back"), s.P6.isBindPressed(e.left) && this.onMoved("left"), s.P6.isBindPressed(e.right) && this.onMoved("right");
                                break;
                            case "default":
                                s.P6.isBindPressed(e.forward) && this.onMoved("forward", t), s.P6.isBindPressed(e.back) && this.onMoved("back", t), s.P6.isBindPressed(e.left) && this.onMoved("left", t), s.P6.isBindPressed(e.right) && this.onMoved("right", t);
                            case "airWalk":
                                s.P6.isBindPressed(e.up) && this.onMoved("up"), s.P6.isBindPressed(e.down) && this.onMoved("down")
                        }
                    };
                    reset = () => this.#e = !1;
                    process = (t, e, a) => {
                        if (t && e) {
                            if (s.P6.isBindPressed(this.#t.toggleStateData) && this.toggleState(t), !0 !== this.#e) return this.setRayLenght(a, 50);
                            this.keyHandler(e.currState_0.direction), this.alignTank(t, e.currState_0.direction), this.setPosition(t), t.body.movable = "airWalk" === this.#t.typeData.state, "airWalk" === this.#t.typeData.state && this.setRayLenght(a, 1e100)
                        }
                    }
                }
            },
            38: (t, e, a) => {
                ...
                class s {
                    ...
                    #r = !1;
                    #l;
                    #t = i.vc.data.cameraData;
                    reset = () => {
                        this.#o = !1, this.#n = void 0, this.#l = void 0
                    };
                    spectate = t => {
                        this.#n = t
                    };
                    ...
                    distance = () => {
                        this.#t.state && (this.#i += 1e3, this.#i > 2500 && (this.#i = 500))
                    };
                    nextTarget = () => {
                        let t = i.P6.getTanks();
                        i.P6.isArrayValid(t) && (this.#s >= t.length && (this.#s = 0), this.#n = t[this.#s], this.#s++)
                    };
                    process = (t, e) => {
                        let a = i.vc.data.spectateData;
                        i.P6.isBindPressed(this.#t) && this.distance(), i.P6.isBindPressed(a.deactivateData) && this.deactivate(), i.P6.isBindPressed(a.nextTargetData) && this.nextTarget(), !this.#o && t && e && (this.#l = t, t.polarDistance_0.copy = t.polarDistance_0.update_dleff0$, t.pitch_0.copy = t.pitch_0.update_dleff0$, t.elevation_0.copy = t.elevation_0.update_dleff0$, t.pivot_0.copy = t.pivot_0.update_sl07mc$, t.polarDistance_0.update_dleff0$ = function(t, e) {
                            if (!1 === i.$l.#t.state) return this.copy(t, e);
                            this.value += (i.$l.#i - this.value) / 20
                        }, t.pitch_0.update_dleff0$ = function(e, a) {
                            if (!1 === i.$l.#t.state) return this.copy(e, a);
                            this.value = t.absoluteIdealPitch_0
                        }, t.elevation_0.update_dleff0$ = function(t, e) {
                            if (!1 === i.$l.#t.state) return this.copy(t, e);
                            this.value = e
                        }, t.pivot_0.update_sl07mc$ = function(t, e) {
                            let a = i.$l.#n?.TankPhysicsComponent?.body;
                            this.copy(t, a ? a.state.position : e)
                        }, e.cameraDown_0 = function(t) {
                            if (i.Ri.state && i.P6.getKeyState("KeyE") || i.$l.#t.state) return this.down_0 = !1;
                            this.down_0 = t.isPressed
                        }, e.cameraUp_0 = function(t) {
                            if (i.Ri.state && i.P6.getKeyState("KeyQ") || i.$l.#t.state) return this.up_0 = !1;
                            this.up_0 = t.isPressed
                        }, !0 !== this.#r && (document.addEventListener("mousemove", (t => {
                            !1 !== this.#t.state && this.#l && document.pointerLockElement && (this.#l.pathPosition += 525e-6 * t.movementY)
                        }), !1), this.#r = !0), this.#o = !0)
                    }
                }
            },
            24: (t, e, a) => {
                ...
                class s {
                    ...
                    reset = () => {
                        this.temp = !1, this.#c = void 0, this.#d = void 0
                    };
                    getSupplyByName = t => this.#c.get_11rb$(this.#c.head_1lr44l$_0?.key.constructor[t]);
                    activateSupply = (t, e = !1) => {
                        if (e) {
                            let e = Array.from(i.UJ.world?.inputManager?.input?.gameActions_0?.map);
                            if (!i.P6.isArrayValid(e)) return;
                            for (const a of e)
                                if (a[0].name === t) return a[1].wasPressed = !0, void(a[1].wasReleased = !0)
                        }
                        const a = i.UJ.localTank?.TankPhysicsComponent.body?.state;
                        a?.position && 0 !== a.position.x && 0 !== a.position.y && 0 !== a.position.z && 0 !== i.UJ.localTank?.HealthComponent?.health && i.oQ.serverState && this.getSupplyByName(t)?.onUserActivatedSupply()
                    };
                ...
                class s {
                    ...
                    shellsTeleport = (e, t) => {
                        ...
                        for (const e of s) {
                            ...
                            t && (t.staticHit_0 = () => {}, t.selfDestruct_0 = () => {}, t.tankHit_0 = function(e) {
                                this.updateState_0(), i.P6.match(this.shellStates_0.lastKnownState_0.position, "distance_")?.(i.Z_.lastSendState.position) > 1100 && this.serverInterface_0.tryToHit_nn87qu$(this.world.physicsTime, this.raycastShell_0.shellId, this.shellStates_0, e.targetEntity)
                            })
                        }
                        if (!a.state || !this.rocketTP.target) return;
                        const o = i.P6.getTankById(this.rocketTP.target)?.TankPhysicsComponent?.body?.state;
                        if (o && (!0 === this.rocketTP.state || s.length !== e.salvoRocketsCount || this.rocketTP.timeout || (this.rocketTP.timeout = setTimeout((() => {
                                this.rocketTP.state = !0, this.rocketTP.timeout = void 0
                            }), 2e3)), i.P6.isBindPressed(a) && (this.rocketTP.state = !0), this.rocketTP.state && (this.rocketTP.timeout && (clearTimeout(this.rocketTP.timeout), this.rocketTP.timeout = void 0), this.rocketTP.state = !1, i.P6.match(o.position, "distance_")?.(i.Z_.lastSendState.position) > 1100)))
                            for (const e of s) {
                                const t = e.components.StrikerRocketComponent;
                    ...
                    process = (e, t, a, s, o, n, r, c) => {
                        ...
                        }, t.__proto__.createShell_0 = function(e) {
                            if (i.vR.#e.shellsTeleportData.state) {
                                const t = i.P6.getTankById(i.vR.rocketTP.target)?.TankPhysicsComponent?.body?.state;
                                if (!t) return;
                                if (e.direction.init_y2kzbl$(0, 0, 0), i.vR.rocketTP.teleportToTarget) {
                                    const e = c.tankPhysicsComponent_0.getInterpolatedBodyState();
                                    e.position.x = t.position.x, e.position.y = t.position.y, e.position.z = t.position.z + 100, i.Z_.sendUpdate(c, e)
                                }
                            }
                            s.sendUpdate_0(!0), this.shellCommunicationServer_0.tryToShoot_595qrd$(this.world.physicsTime, 0, e.shellId, e.direction)
            ...
            272: (e, t, a) => {
                ...
                class o {
                    ...
                    isRandomTPEnabled = !1;
                    reset = () => {
                        this.forceSkip = !1, this.skip = !1, this.#i = !1, this.#h = 0, clearInterval(this.#p)
                    };
                    isRocketsExist = e => {
                    ...
                    randomPosition = e => {
                        ...
                        a && (e.position.x = i.P6.getUniqueRandomArbitrary(this.lastSendState.position.x, 3e3, a.minX, a.maxX), e.position.y = i.P6.getUniqueRandomArbitrary(this.lastSendState.position.y, 3e3, a.minY, a.maxY), e.position.z = Math.round(Math.random()) ? a.maxZ : t.bounds.maxZ + 500, e.orientation.x = 0, e.orientation.y = 0)
                    };
                    compareDistance = e => !this.skip && !this.forceSkip && i.P6.match(e, "distance_")?.(this.lastSendState.position) < 300;
                    sendUpdate = (e, t) => {
                        if (i.oQ.responseTime >= 2e3) return;
                        const a = i.UJ.localTank?.TankComponent?.state?.name;
                        if ("ACTIVE" !== a) return;
                        const s = i.P6.isNotKillZone(t.position);
                        0 !== s && i.P6.outKillZone(t.position, s), i.UJ.localTank.StrikerWeapon && this.compareDistance(t.position) || (this.lastSendState.position = t.position.clone(), this.lastSendState.orientation = t.orientation.clone(), t.velocity.init_y2kzbl$(0, 0, 0), t.angularVelocity.init_y2kzbl$(0, 0, 0), e.sendUpdate_0(t, e.world.physicsTime))
                    };
                    process = (e, t, a, o) => {
                        if (i.P6.isBindPressed(this.#e.antiStrikerData) && (this.#e.antiStrikerData.state = !this.#e.antiStrikerData.state), i.P6.isBindPressed(this.#e.randomTeleportData) && (this.#e.randomTeleportData.state = !this.#e.randomTeleportData.state), i.P6.isBindPressed(this.#e.antiMineData) && (this.#e.antiMineData.state = !this.#e.antiMineData.state), e && this.#i && !this.skip && !this.forceSkip && e.world.physicsTime > this.#h && (this.#h = e.world.physicsTime + this.#e.updateInterval, e.sendState_0(e.tankPhysicsComponent_0.getInterpolatedBodyState())), !this.#i) {
            ...
            662: (e, t, a) => {
                ...
                class o {
                    ...
                    get root() {
                        ...
                        return e ? this.#g = e._reactRootContainer?._internalRoot?.current?.memoizedState?.element?.type?.prototype?.store : i.P6.debug(s, 17, "GameObjects::get root", "root (expected HTMLElement) invalid")
                    }
                    get world() {
                        return this.#y ? this.#y : this.#y = i.P6.getComponentNames(this.root?.subscribers?.toArray())?.ChassisSettingsUpdater?.tank?.world
                    }
                    get gameMode() {
                    ...
                    get localTank() {
                        if (this.#f && i.P6.isArrayValid(this.#f.originalArray)) return this.#f;
                        if (!this.gameMode) return;
                        let e = this.gameMode.originalArray[0]?.gameMode_0?.possesedTank;
                        return e ? (this.#f = i.P6.getComponentNames(e.components_0?.array), this.#f && (this.#f.entity = e), this.#f) : i.P6.debug(s, 46, "GameObjects::get localtank", "possedTank (expected BattleEntity) invalid")
                    }
                    reset = () => {
                        this.#k = void 0, this.#f = void 0, this.#y = void 0
                    }
                }
            },
            487: (e, t, a) => {
                ...
                class s {
                    ...
                    openingAnimation = () => {
                        40 !== this.#I ? this.#I += 4 : this.#B = !1
                    };
                    closingAnimation = () => {
                        0 !== this.#I ? this.#I -= 4 : this.#B = !1, this.#B || this.hideMenu()
                    };
                    applyFilter = e => {
                        canvas.style.opacity = e / 40 * 1, root.style.filter = `blur(${.1*e}px) brightness(${1-e/100})`
                    };
                    animationTask = () => {
                        this.#B && requestAnimationFrame(this.animationTask), this.isOpen ? this.openingAnimation() : this.closingAnimation(), this.applyFilter(this.#I)
                    };
                    showMenu = () => {
                    ...
                    onMenuKeyPressed = () => {
                        (this.isOpen = !this.isOpen) && this.showMenu(), this.#B = !0, requestAnimationFrame(this.animationTask)
                    };
                    createTabButton = (e, t) => {
            ...
            817: (e, t, a) => {
                ...
                var i = a(75),
                    ...
                    I = a(105),
                    B = a(125);
                const b = unsafeWindow.utils = new i.Z,
                    v = unsafeWindow.gameObjects = new s.Z,
                ...
                ! function e() {
                    ...
                    return t ? (S.openStore(t), t.state?.battleStatistics?.inBattle() ? (T.process(c), _.process(s, d, h, D), V.process(u, p), L.process(), E.process(), i && b.isArrayValid(i.originalArray) ? (P.process(s, o, r, m), G.process(o, n), x.process(s), A.process(l), M.process(m, g, t, I), void $.process(y, k, f, I, B, D, C, m)) : Z()) : (v.reset(), Z())) : b.debug("src/index.js", 90, "main", "root === undefined (expected object)")
                }()
            }
        },
        t = {};
    ...
    }, a(817), a(662), a(487), a(580), a(600), a(680), a(75), a(232), a(975), a(374), a(105), a(995), a(422), a(1), a(641), a(229), a(500), a(462), a(38), a(24), a(551), a(956), a(867), a(125), a(272), a(842)
})();
